import{m as u,g as f,e as h,s as g,r as y}from"./index-81c1d2af.js";import{f as F}from"./feather-becb2378.js";const v=function(r,e,t){return console.log(r,e,t),fetch(`${e}/wps?service=WPS&outputFormat=json`,{headers:{accept:"application/json","accept-language":"de-DE,de;q=0.5","content-type":"application/xml"},referrer:"https://geoserver.dainst.org/catalogue/",body:`
    ...
    `,$=()=>{u.store("geonodeCustomLayerFilter",{componentIsActive:!1,currentLayerName:"",currentValueSelect:null,url:"",corsInformation:"",nameSelectOptions:[],allFormValues:{},enabledPlugins:f(),closeComponent:function(){this.componentIsActive=!1,console.log(this.componentIsActive),h("geonodeCustomLayerFilterClosed",{})},submitFilterForm:function(){const e=this.allFormValues[this.currentFormId];u.store("pluginStatus").registeredPluginNames,this.layer.updateParams({CQL_FILTER:e}),this.enabledPlugins.includes("layerPanel")&&u.store("layerPanel").activeFilters.push(this.currentLayerName)},clearFilterForm:function(){this.allFormValues[this.currentFormId]="",document.querySelector("#"+this.currentFormId).querySelectorAll(".row").forEach(s=>{s.remove()}),this.layer.updateParams({CQL_FILTER:"(1=1)"}),this.enabledPlugins.includes("layerPanel")&&(u.store("layerPanel").activeFilters=u.store("layerPanel").activeFilters.filter(s=>s!==this.currentLayerName))},hasActiveFilters:function(){const e=this.allFormValues[this.currentFormId];return e?e.length==0:!0},visibleAttributes:function(){return this.nameSelectOptions.filter(e=>e.visible).map(e=>e.attribute)},updateaOnNameSelect:function(e){const t=e.value,s=t.trim()!==""&&t.trim()!=="-",o=e.closest(".row"),n=o.querySelector(".operator"),a=o.querySelector(".value");this.currentValueSelect=a,n.disabled=!s,a.disabled=!s,v(t,this.url,this.alternate).then(l=>{this.currentValueSelect.innerHTML="",l.values.forEach(i=>{if(i!==""){const c=document.createElement("option");c.value=i,c.textContent=i,this.currentValueSelect.appendChild(c),this.currentValueSelect.classList.add("updated")}}),this.updateallFormValues()}).catch(l=>console.error("Error:",l))},runCorsTest:async function(){const e=this.url,t=await x(e);console.log("CORS Test Results:",t),this.corsTestpassed=t.postResult.success,this.corsInformation="Server does not support POST requests",this.corsTestpassed&&(this.corsInformation="Test passed")},updateallFormValues:function(){const e=this.currentFormId,t=document.querySelector(`#${e}`),s=document.querySelectorAll(`#${e} .row`);var o=t.getElementsByClassName("or_operator_selector")[0];o=o.checked?" OR ":" AND ";let n="";s.forEach(l=>{const i=l.querySelector(".name"),c=l.querySelector(".operator"),d=l.querySelector(".value"),m=i?i.value:null,p=c?c.value:null,w=d?d.value:null;m&&m.trim()!==""&&m.trim()!=="-"&&p&&w&&(n+=`("${m}"${p}'${w}')${o}`)});const a=o.length;n&&(n=n.slice(0,-a)),this.allFormValues[e]=n},currentFormId:"",handlelayerChange:function(){const e=document.querySelector(".formContent"),t=I(this.currentFormId);document.querySelector("#"+this.currentFormId)?console.log("Form exists for:",this.currentFormId):e.insertAdjacentHTML("beforeend",t)},removeItem:function(e){const t=document.querySelector(`[data-id="${e}"]`);console.log(t),t.remove(),this.updateallFormValues(),this.submitFilterForm(),this.hasActiveFilters()==!0&&this.clearFilterForm()},addItem:function(e){const t=document.querySelector("#"+e),s=t.querySelector(".addItem"),o=document.querySelector("template.formRow");t&&o&&(s.insertAdjacentHTML("beforebegin",o.innerHTML),F.replace())}}),document.addEventListener("filterPushed",function(e){console.debug('Custom event "filterPushed" caught in filterLayer/filterLayer.js');const t=u.store("geonodeCustomLayerFilter"),s=e.detail.instance,o=s.dataset;t.layer=s,t.alternate=o.alternate,t.currentLayerName=s.mapName,t.url=s.getUrl(),t.nameSelectOptions=o.attribute_set,t.currentFormId=g(s.mapName),t.handlelayerChange(),t.componentIsActive=!0,t.runCorsTest()}),y([[b,"#filterOffcanvas"]])};export{$ as initialize};
//# sourceMappingURL=geonodeCustomLayerFilter-329c234c.js.map
